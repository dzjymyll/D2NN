...
if __name__ == '__main__':
    ...
    with tf.name_scope("datasets"):
        ...
        # DEFINE THE ITERATOR
        iterator = tf.compat.v1.data.Iterator.from_structure(tf.compat.v1.data.get_output_types(batch_train), tf.compat.v1.data.get_output_shapes(batch_train))
        train_init_op = iterator.make_initializer(batch_train)
